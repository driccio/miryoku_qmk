...
//    #elif defined (MIRYOKU_ALPHAS_OPTIMOT)
//      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_OPTIMOT_FLIP
    #else
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_FLIP
    #endif
  #else
...
//    #elif defined (MIRYOKU_ALPHAS_OPTIMOT)
//       #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_OPTIMOT_FLIP
    #else
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_COLEMAKDH_FLIP
    #endif
  #else
...
//    #if defined (MIRYOKU_LAYERS_FLIP)
//      #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_OPTIMOT_FLIP
//    #else
...
//    #endif
 ...
 #if defined (MIRYOKU_ALPHAS_OPTIMOT)
//    #if defined (MIRYOKU_LAYERS_FLIP)
//      #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_OPTIMOT_FLIP
//    #else
