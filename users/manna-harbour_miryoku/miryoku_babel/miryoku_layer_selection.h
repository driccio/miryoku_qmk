...
#include "bepo_alternative.h"
  ...
  #define MIRYOKU_LAYERMAPPING_MEDIA MIRYOKU_MAPPING
    ...
    #if defined (MIRYOKU_LAYERS_FLIP)
      #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_BEPO_FLIP
    #else
      #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_BEPO
    #endif
  #else
    #if defined (MIRYOKU_LAYERS_FLIP)
 ...
 #if defined (MIRYOKU_ALPHAS_BEPO)
    #if defined (MIRYOKU_LAYERS_FLIP)
      #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_BEPO_FLIP
    #else
      #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_BEPO
    #endif
  #else
    #if defined (MIRYOKU_LAYERS_FLIP)
